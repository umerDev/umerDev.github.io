...
const experiences: ExperienceItem[] = [
  {
    ...
    company: "Mark43",
    companyLogo:
      "https://uploads-us-west-2.insided.com/mark43-en/attachment/18770f64-87ff-42bc-bb42-d00441b9f5a2_thumb.png",
    location: "Manchester",
  ...
  },
  {
    ...
    company: "Oval3 (Web3)",
    companyLogo:
      "https://media.licdn.com/dms/image/v2/D4E0BAQFI7KVJWXIQ6w/company-logo_200_200/company-logo_200_200/0/1665670617347/oval3_game_logo?e=2147483647&v=beta&t=CvAgc568uQVDLZCBXdYQMH_5H2c4srCdgoAh0LgIgZQ",
    location: "Remote",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          {experiences.map((exp, index) => (
            <Card
              key={index}
              className="mb-6 overflow-hidden hover:shadow-lg transition-shadow"
            >
