        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-6">
              Hey there! I'm Umer, a Technical Lead who thrives on innovation
              and agility. With over 9 years of professional experience, I’ve
              had the joy of guiding development squads to build
              high-performance, cloud native solutions that scale and perform.
            </p>
            <p className="text-gray-700 mb-8">
              I have experience with <strong>TypeScript</strong>,{" "}
              <strong>React</strong>, <strong>Vue</strong>, <strong>Go</strong>,{" "}
              <strong>C#</strong>, <strong>Java</strong>, and{" "}
              <strong>Python</strong>. I have experience in major cloud
              providers: AWS, GCP, and Azure. From event-driven architectures to
              CI/CD pipelines. I’m passionate about crafting solutions that
              empower teams and deliver real product impact. Mentoring fellow
              engineers is something that I enjoy, and I’m always looking to
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Card className="card-hover">
                <CardContent className="p-6 flex flex-col items-center text-center">
                  <div className="text-4xl font-bold text-tech-purple mb-2">
                    Product Driven
                  </div>
                  <p className="text-gray-600">
                    Team Mentor & Cloud Enthusiast
                  </p>
                </CardContent>
              </Card>
            </div>
